package com.mindharness.agent.tools;

import com.mindharness.lsp.LspMessage;
import com.mindharness.lsp.LspService;
 ...
 * LSP 代码分析工具
 * <p>
 * 将 LSP 能力以 Tool 的形式接入 MindHarness Agent 体系。
 * Agent（LLM）可以自主决定何时调用本工具来分析用户提供的代码。
 * <p>
 * 实现模式与 {@link DataBaseTools} 一致：
 * <ul>
 *   <li>实现 {@link Tool} 接口 → 纳入 MindHarness 工具管理</li>
